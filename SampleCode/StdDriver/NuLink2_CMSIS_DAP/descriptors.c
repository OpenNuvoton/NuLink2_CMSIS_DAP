...
uint8_t HID_DeviceReportDescriptor[] __attribute__((aligned(4))) =
{
    ...
    0x96, (EPA_MAX_PKT_SIZE & 0xFF), ((EPA_MAX_PKT_SIZE >> 8) & 0xFF),       /* REPORT_COUNT*/
    0x09, 0x01,
    0x81, 0x02,             /* INPUT (Data,Var,Abs)*/
    0x96, (EPB_MAX_PKT_SIZE & 0xFF), ((EPB_MAX_PKT_SIZE >> 8) & 0xFF),       /* REPORT_COUNT*/
    0x09, 0x01,
...
#ifdef __ICCARM__
#pragma data_alignment=4
uint8_t HID_DeviceReportDescriptorFS[] =
{
#else
uint8_t HID_DeviceReportDescriptorFS[] __attribute__((aligned(4))) =
{
#endif
    0x06, 0x00, 0xFF,       /* USAGE_PAGE (Vendor Defined)*/
    0x09, 0x01,             /* USAGE (0x01)*/
    ...
    0x26, 0xFF, 0x00,       /* LOGICAL_MAXIMUM (255)*/
    0x75, 0x08,             /* REPORT_SIZE (8)*/
    0x96, (EPA_OTHER_MAX_PKT_SIZE & 0xFF), ((EPA_OTHER_MAX_PKT_SIZE >> 8) & 0xFF),       /* REPORT_COUNT*/
    0x09, 0x01,
    0x81, 0x02,             /* INPUT (Data,Var,Abs)*/
    0x96, (EPB_OTHER_MAX_PKT_SIZE & 0xFF), ((EPB_OTHER_MAX_PKT_SIZE >> 8) & 0xFF),       /* REPORT_COUNT*/
    0x09, 0x01,
    0x91, 0x02,             /* OUTPUT (Data,Var,Abs)*/
    0x95, 0x08,             /* REPORT_COUNT (8) */
    0x09, 0x01,
...
uint8_t gu8ConfigDescriptorFS[] __attribute__((aligned(4))) =
{
    ...
    DESC_HID_RPT,   /* Descriptor type. */
    /* Total length of report descriptor. */
    sizeof(HID_DeviceReportDescriptorFS) & 0x00FF,
    ((sizeof(HID_DeviceReportDescriptorFS) & 0xFF00) >> 8),
...
uint8_t gu8ProductStringDesc[] __attribute__((aligned(4))) =
{
    ...
    38,             /* bLength          */
    DESC_STRING,    /* bDescriptorType  */
    'N', 0, 'u', 0, '-', 0, 'L', 0, 'i', 0, 'n', 0, 'k', 0, '2', 0, ' ', 0, 'C', 0, 'M', 0, 'S', 0, 'I', 0, 'S', 0, '-', 0, 'D', 0, 'A', 0, 'P', 0,
};
...
uint8_t *gu8UsbHidReportFS[3] =
{
    HID_DeviceReportDescriptorFS,
    NULL,
    NULL,
};
...
uint32_t gu32UsbHidReportLenFS[3] =
{
    sizeof(HID_DeviceReportDescriptorFS),
    0,
    0,
};
